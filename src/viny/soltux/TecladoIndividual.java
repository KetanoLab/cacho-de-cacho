...
*/
public class TecladoIndividual extends BaseExample {
	...
	public Scene onLoadScene() {
		...
		// eliminar jugador
				delete = new AnimatedSprite(440, 10, this.deletet) {
					@Override
					public boolean onAreaTouched(final TouchEvent Event,
							final float pTouchAreaLocalX, final float pTouchAreaLocalY) {
						if (Event.getAction() == MotionEvent.ACTION_DOWN) {
				...
				texto30 = new Text(460, 30, this.mFont3, "-");
				scene.attachChild(delete);
				scene.registerTouchArea(delete);
				scene.attachChild(texto30);
				texto30.setScale(3.0f);
				// ir
				go = new AnimatedSprite(500, 10, this.got) {
					@Override
					public boolean onAreaTouched(final TouchEvent Event,
							final float pTouchAreaLocalX, final float pTouchAreaLocalY) {
						if (Event.getAction() == MotionEvent.ACTION_DOWN) {
							if(cont>0){
							Intent a = new Intent(TecladoIndividual.this,CachovIndividual.class);	
							a.putExtra("vector", nombres);
							a.putExtra("contador", cont);
							TecladoIndividual.this.startActivity(a);
							TecladoIndividual.this.finish();
							}
							this.setCurrentTileIndex(1);
						} else {
							this.setCurrentTileIndex(0);
				...
				texto31 = new Text(516, 22, this.mFont3, "ir");
				...
				/// boton agregar
				agregar = new AnimatedSprite(380, 10, this.agregart) {
					@Override
					public boolean onAreaTouched(final TouchEvent Event,
							final float pTouchAreaLocalX, final float pTouchAreaLocalY) {
						if (Event.getAction() == MotionEvent.ACTION_DOWN) {
				...
				texto32 = new Text(398, 32, this.mFont3, "+");
