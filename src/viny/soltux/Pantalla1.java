...
*/
public class Pantalla1 extends BaseExample {
	// ===========================================================
	// Constants
	// ===========================================================
	int a;
	...
	public void onLoadResources() {
		...
		this.mFaceTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(this.mBitmapTextureAtlas, this, "ketano.png", 0, 0);
		...
		final Sprite face = new Sprite(0, 0, this.mFaceTextureRegion) {
			...
			protected void applyRotation(final GL10 pGL) {
				if((int)System.currentTimeMillis()>a){
					Intent a = new Intent(Pantalla1.this,Pantalla2.class);
					Pantalla1.this.startActivity(a);
