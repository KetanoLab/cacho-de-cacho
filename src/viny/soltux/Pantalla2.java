...
*/
public class Pantalla2 extends BaseExample {
	// ===========================================================
	// Constants
	// ===========================================================
	int a;
	...
	public void onLoadResources() {
		...
		this.mFaceTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(this.mBitmapTextureAtlas, this, "cachodecacho.png", 0, 0);
		...
		final Sprite face = new Sprite(0, 0, this.mFaceTextureRegion) {
			...
			protected void applyRotation(final GL10 pGL) {
				if((int)System.currentTimeMillis()>a){
					Intent a = new Intent(Pantalla2.this,MenuPrincipal.class);
					Pantalla2.this.startActivity(a);
