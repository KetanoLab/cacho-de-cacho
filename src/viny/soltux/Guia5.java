...
*/
public class Guia5 extends BaseExample {
	...
	public void onLoadResources() {
		...
		this.mFaceTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(this.mBitmapTextureAtlas, this, "tuto5.png", 0, 0);
		...
		final AnimatedSprite botonIzq= new AnimatedSprite(-20,360,this.tfi){
			...
			public boolean onAreaTouched(final TouchEvent pSceneTouchEvent,
				...
				if (pSceneTouchEvent.getAction() == MotionEvent.ACTION_DOWN) {
					...
					this.setCurrentTileIndex(0);
					Intent a = new Intent(Guia5.this,Guia4.class);
					Guia5.this.startActivity(a);
					Guia5.this.finish();
				}
			return true;
		}
