...
*/
public class Guia3 extends BaseExample {
	...
	public void onLoadResources() {
		...
		this.mFaceTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(this.mBitmapTextureAtlas, this, "tuto3.png", 0, 0);
		...
		final AnimatedSprite botonDer= new AnimatedSprite(600,360,this.tfd){
			...
			public boolean onAreaTouched(final TouchEvent pSceneTouchEvent,
				...
				if (pSceneTouchEvent.getAction() == MotionEvent.ACTION_DOWN) {
					...
					Intent a = new Intent(Guia3.this,Guia4.class);
					Guia3.this.startActivity(a);
					Guia3.this.finish();
				}
			return true;
		}
		...
		final AnimatedSprite botonIzq= new AnimatedSprite(-20,360,this.tfi){
			...
			public boolean onAreaTouched(final TouchEvent pSceneTouchEvent,
				...
				if (pSceneTouchEvent.getAction() == MotionEvent.ACTION_DOWN) {
					...
					this.setCurrentTileIndex(0);
					Intent a = new Intent(Guia3.this,Guia2.class);
					Guia3.this.startActivity(a);
					Guia3.this.finish();
				}
			return true;
